...
const Player = () => {
  ...
  return (
    <div>
      ...
      <div>
        url: <input type="text" ref={urlRef} style={{ width: 500 }} defaultValue="ezopen://open.ys7.com/BC7799091/1.hd.live" />
      </div>
      <div>
        accessToken:
        <input type="text" ref={accessTokenRef} style={{ width: 500 }} defaultValue="at.d525oyj8d7bwohb40ssn3266cfq2mwi2-8hgpypehn9-1fafaty-ea2fxbc1" />
      </div>
      <div>
        staticPath:
        <input type="text" ref={staticPathRef} style={{ width: 500 }} defaultValue="" />
      </div>
      <div>
